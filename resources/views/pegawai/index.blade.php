...
@section('konten')
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tambahPegawai">Tambah Pegawai</a>
                                </div>
                            </div>
                            <div class="card-body">
    ...
    <div class="modal fade" id="tambahPegawai" tabindex="-1" aria-labelledby="exampleModalgridLabel" aria-modal="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalgridLabel">Tambah Pegawai</h5>
