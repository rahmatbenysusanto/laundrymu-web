                                            ...
                                            <td>
                                                <div class="dropdown d-inline-block">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        <li>
                                                            <a href="/edit-diskon/{{ base64_encode($dis->id) }}" class="dropdown-item edit-item-btn">
                                                                <i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item remove-item-btn" onclick="hapusDiskon('{{ $dis->id }}')">
                            ...
                            if (res.status) {
                                Swal.fire({
                                    html:'<div class="mt-3">' +
                                        ...
                                        '<h4>Berhasil !</h4>' +
                                        '<p class="text-muted mx-4 mb-0">Hapus diskon berhasil.</p>' +
                                        '</div>' +
                                        '</div>',
                                    showCancelButton:!0,
                                    showConfirmButton:!1,
